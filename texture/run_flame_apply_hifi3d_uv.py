# MODIFIED CODE FROM FFHQ-UV (https://github.com/csbhr/FFHQ-UV)
import os
import re
import numpy as np
import argparse
...
def read_eyeball_uvs(eyeball_obj_path):
    eyeball_data = read_mesh_obj(eyeball_obj_path)
    return eyeball_data['vt']
